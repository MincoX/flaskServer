...
@api_vsubscribe.route('/uploadAvatar', methods=['POST'])
def subscribe_upload_avatar():
    code = 200
    data = {}
    message = '图片上传成功！'
...
@api_vsubscribe.route('/submitApply', methods=['POST'])
def subscribe_submit_apply():
    code = 200
    data = {}
    message = 'success'
...
@api_vsubscribe.route('/adminLogin', methods=['POST'])
def subscribe_admin_login():
    code = 200
    data = {}
    message = 'success'
...
@api_vsubscribe.route('/getUsers', methods=['GET'])
...
@api_vsubscribe.route('/auditUser', methods=['POST'])
